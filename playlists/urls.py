...
from .views import PlaylistDetailView, PlaylistListView, PlaylistReorderView, PlaylistSongManageView
...
urlpatterns = [
    ...
    path('playlists/<uuid:pk>/songs/reorder/', PlaylistReorderView.as_view(), name='playlists-reorder'),
